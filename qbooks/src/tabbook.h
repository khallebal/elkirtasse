...
public slots:
     ...
     */
    int  openDataBase(const QString &name,const QString &title,const QString &Autor,int position=0) ;        //فتح الكتاب
...
private:
  ...
  //  bool m_fitInwidth;
   ...
   //اوامر
    ...
    //
    PdfInterface *pdfDoc;       //! اداة كتاب من نوع بي دي اف
